                ...
                <div className="grid gap-12 md:grid-cols-[1fr_auto] md:items-end">
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-8 text-lg leading-8 text-muted">
                            Ruta de progreso de los laboratorios prácticos de la asignatura: File Path Traversal, Directory Traversal, es una vulnerabilidad que permite a un atacante navegar por los directorios del servidor para acceder a archivos que no deberían ser accesibles.
                        </p>
                    </div>
